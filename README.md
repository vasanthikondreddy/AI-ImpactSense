# 🌍 Earthquake Predictor Dashboard
...
- Visualize results with a **doughnut chart**.
- Preview dataset in a **scrollable table** with color-coded rows.
- Responsive layout with **left panel (inputs)** and **right panel (dataset + chart)**.
...
- **Styling:** CSS (modular, card-based layout)
